        ...
        >
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div className="md:col-span-2">
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full rounded-lg border border-border bg-background px-4 py-3 text-sm focus:border-red-500/50 focus:outline-none focus:ring-2 focus:ring-red-500/20 resize-none"
                />
              </div>
            </div>
          </div>
          ...
          <div className="rounded-xl border border-border bg-card p-6">
            ...
            <div className="space-y-4">
              {[
                { label: 'New coach signups', description: 'Get notified when a new coach registers' },
                { label: 'Subscription changes', description: 'Alerts for upgrades, downgrades, and cancellations' },
                { label: 'Weekly reports', description: 'Receive weekly platform analytics summary' },
              ].map((item) => (
                <div key={item.label} className="flex items-center justify-between">
                  ...
                  <button className="relative inline-flex h-6 w-11 shrink-0 items-center rounded-full bg-red-500 transition-colors">
